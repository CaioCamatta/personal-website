  ...
  <Layout>
    ...
    <div className="">
      <div style={{
        ...
        <h3 className="text-2xl sm:text-3xl md:text-5xl pt-10 sm:pt-16 xl:pt-32 pb-2 text-gray-800 font-light">Websites</h3>
        ...
        <h3 className="text-2xl sm:text-3xl md:text-5xl pt-10 sm:pt-16 xl:pt-32 pb-2 text-gray-800 font-light">Apps</h3>
        ...
        <h3 className="text-2xl sm:text-3xl md:text-5xl pt-10 sm:pt-16 xl:pt-32 pb-2 text-gray-800 font-light">Hackathons</h3>
